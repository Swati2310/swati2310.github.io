  ...
  const experiences = [
    {
      ...
      type: "Internship",
      current: true,
      description: "Spearheading the development of a Sales Analytical Tool (MVP) for Get Up and Go Kayaking, enabling data-driven business insights from real-time weather and booking data. Designed a React + TypeScript frontend and deployed secure backend APIs using Python, Supabase, and PostgreSQL. Integrated OpenWeather API to collect real-time weather metrics and correlate them with booking trends for predictive insights. Implemented visual dashboards using D3.js-style charts and deployed scalable infrastructure via Cloudflare and Vercel."
    },
    {
      ...
      type: "Full-time",
      current: false,
      description: "Installed Finacle Core Banking on OpenShift and AWS clusters, establishing and managing environments for 20+ applications. Built and deployed JFrog and ECR images in Kubernetes namespaces and AWS, automating patch deployments and managing deliverables, resulting in an 85% reduction in deployment time. Deployed and managed Dockerized applications on AWS EKS, using Kubernetes, Docker, Ansible, and GitLab to create 15+ CI/CD pipelines, achieving a 40% reduction in infrastructure costs. Led a DevOps team of 3 in managing end-to-end development and operations for projects in SEPA and APAC region."
    },
    {
      ...
      type: "Full-time",
      current: false,
      description: "Maintained OLAP data and production environment reliability for Finacle e-banking by replicating and creating 50+ databases across multiple accounts to support application structure changes in the APAC region. Managed and optimized 10+ cloud servers by configuring crontab jobs, archiving logs, ensuring efficient disk management, and using Jenkins CI/CD pipelines for source code deployment, backups, and memory alerts. Generated 20+ detailed reports with RReport, optimizing backend processes through complex SQL and PL/SQL queries. Enhanced Finacle's functionality for an investment banking firm by customizing 100+ web pages and menus using JavaScript and JSPs."
    }
  ];
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className="bg-[#1a1a2e]/80 backdrop-blur-sm rounded-xl border border-purple-500/20 p-6 hover:border-purple-500/40 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20">
                  {/* Date */}
                  <div className="text-white/70 text-sm mb-3 font-medium">
                    {exp.period}
                  </div>
